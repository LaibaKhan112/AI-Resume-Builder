  ...
  return (
    ...
    <div id='features'>
        <style>{`
            ...
            <p className="text-sm text-slate-500 text-center mt-2 max-w-md mx-auto">Everything you need to manage, track, and grow your resumes, smartly and efficiently.</p>
            
            <div  className="flex items-center justify-center flex-wrap gap-6 mt-20 px-4 md:px-0">
                <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 border border-violet-200 gap-6 max-w-sm hover:bg-blue-50 hover:scale-105 transition-transform duration-300">
                    ...
                    <div className="space-y-2 ">
                        <h3 className="text-base font-semibold text-slate-700">Real-Time Editing</h3>
                        <p className="text-sm text-slate-600">Instantly edit and preview your resume with live AI suggestions to make it stand out.</p>
                    </div>
                </div>
                <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 border border-green-200 gap-6 max-w-sm hover:bg-blue-50 hover:scale-105 transition-transform duration-300">
                    ...
                    <div className="space-y-2">
                        <h3 className="text-base font-semibold text-slate-700">Smart Templates</h3>
                        <p className="text-sm text-slate-600">Choose from AI-powered templates that automatically format your resume for maximum impact.</p>
                    </div>
                </div>
                <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 border border-orange-200 gap-6 max-w-sm hover:bg-blue-50 hover:scale-105 transition-transform duration-300">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-slate-600">Download your polished resume in PDF or share it directly with recruiters effortlessly.</p>
                    </div>
                </div>
            </div>
