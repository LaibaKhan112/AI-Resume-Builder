...
const Hero = () => {
  ...
  return (
    <>
            <div id='home' className="min-h-screen pb-20">
                {/* Navbar */}
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                   
                        <Link to='/home' className='text-2xl font-bold flex justify-center items-center gap-2'>
                       <img src="/logo.svg" alt="" className='w-10 h-10'/>resume
                    </Link>
                    ...
                    <div className="flex gap-2">
                        ...
                        <Link to='/auth?state=login' className="hidden md:block px-6 py-2 bg-blue-500 hover:bg-indigo-700 active:scale-95 transition-all rounded-full text-white" >
                            Get Started
                        </Link>
                    </div>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    {/* Headline + CTA */}
                    <h1 className="text-4xl md:text-5xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                        Build professional resumes instantly with <span className=" bg-linear-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent text-nowrap">AI Resume Builder. </span> 
                    </h1>
                    ...
                    <div className="flex items-center gap-4 ">
                        <Link to='/app' className="bg-blue-500 hover:bg-indigo-600 text-white rounded-full px-9 h-12 m-1 ring-offset-2 ring-1 ring-indigo-400 flex items-center transition-colors">
                            Go to dashboard
